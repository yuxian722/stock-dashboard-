...
// 2026/09/07：跟app.js同一天，先改成轉置公式讓0,0在90/270度也釘在右上角，
// 送出當天就被使用者用真實.strate資料抓到問題——轉置在數學上等於偷偷把
// X/Y座標互換，混進了角度選單，跟使用者自己控制的「鏡像」勾選框職責重疊
// (見app.js的rotateWaferPoint()完整說明)。已改回真正的旋轉公式，跟app.js
// 保持同一條。
